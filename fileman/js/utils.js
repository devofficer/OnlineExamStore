...
//FileTypes['image'] = new Array('jpg', 'jpeg', 'png', 'gif', 'avi', 'flv', 'swf', 'wmv', 'mp4', 'mp3', 'wma', 'mpg', 'mpeg', 'doc', 'docx', 'txt', 'rtf', 'pdf', 'xls', 'mdb', 'html', 'htm', 'db');
FileTypes['image'] = new Array('jpg', 'jpeg', 'png', 'gif');
FileTypes['media'] = new Array('avi', 'flv', 'swf', 'wmv','mp4', 'mp3', 'wma', 'mpg','mpeg');
FileTypes['document'] = new Array('doc', 'docx', 'txt', 'rtf', 'pdf', 'xls', 'mdb', 'html', 'htm', 'db');
//FileTypes['all'] = new Array('jpg', 'jpeg', 'png', 'gif', 'avi', 'flv', 'swf', 'wmv', 'mp4', 'mp3', 'wma', 'mpg', 'mpeg','doc', 'docx', 'txt', 'rtf', 'pdf', 'xls', 'mdb', 'html', 'htm', 'db');
function RoxyUtils(){}
